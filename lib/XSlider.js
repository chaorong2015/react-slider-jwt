  ...
  render: function () {
    ...
    if (me.state.renderData && me.state.renderData.length > 0) {
      return React.createElement(
        'div',
        { className: 'component-slider', ref: 'componentSlider', onTouchStart: this.touchStart, onTouchMove: this.touchMove, onTouchEnd: this.touchEnd },
        React.createElement(
          'div',
          { className: 'slider-wraper', ref: 'sliderWraper' },
          me.state.renderData
        ),
        React.createElement('div', { className: 'slider-pagination', ref: 'sliderWPager' })
      );
    } else {
